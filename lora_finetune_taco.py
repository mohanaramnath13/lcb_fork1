...
OUTPUT_DIR = "finetuned-models/deepseek-coder-1.3b-instruct-taco-I2O-allx2-lora"
...
dataset = dataset.map(format_taco_to_chat, batched=True, remove_columns=dataset.features, batch_size=4)
